  ...
  <div class="phone">
      ...
      <div class="container  text-center">
        ...
        <div class="col-sm-9 col-lg-7  main-section">
          ...
          <div class="modal-content">
            ...
            <h2 id="ajouter" style="color:white;">create a new admin:</h2> 
           
              <div class="form-input">
    <form action="{{ route('emails.create')}}" class="needs-validation" novalidate>
            @csrf
            <i class="fas fa-at icons iconsa" style=""></i>
      <div class="form-group col-lg-7 col-md-8 col-sm-12" >
             
                <input type="email" class="form-control my_input" id="email" placeholder="Enter full email" name="email" required>
           ...
           <button type="submit" class="btn btn-success   my_input  col-lg-3">Create</button>
         </form>
         ...
         <div class="container  text-center">
          ...
          <div  class="col-sm-9 col-lg-7  main-section">
            ...
            <div class="modal-content">
              <h2 style="margin-bottom:50px;color:white;" id="modifier" >update an Admin:</h2> 
              <div class="form-input">
        <form action="{{ route('aals.create')}}" class="needs-validation" novalidate>
                @csrf
                <!--select-->
                <div class="form-group  col-lg-7 col-md-8  col-sm-12  ">
                <select name="emails" class="my_input col-lg-12 col-md-13">
                ...
                <button type="submit" class="btn btn-success   my_input  col-lg-3">update</button>
           ...
           <div class="container  text-center" style="margin-bottom:50px;">
            ...
            <div class="col-sm-9 col-lg-7  main-section">
              ...
              <div class="modal-content">
                <h2 style="margin-bottom:50px;color:white;" id="supprimer">delete an Admin:</h2> 
                <div class="form-input">
          <form action="{{ route('aals.create')}}" class="needs-validation" novalidate>
                  @csrf
              <!--select-->
   ...
   (function() {
     ...
     window.addEventListener('load', function() {
       ...
       var forms = document.getElementsByClassemail('needs-validation');
