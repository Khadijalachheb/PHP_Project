  ...
  @if($_SESSION['role']=="Admin_Wilaya") 
    ...
    <div class="row">
      ...
      @foreach ($aals as $aal)
          ...
          @if($aal->name != "Wilaya Souss Massa")
          @if($aal->id=="12")
          <li class="aal2 aal  col-12 col-lg-5 col-md-5 col-sm-12 ">
            <a href="/logger/{{$aal->id}}" class="myaal">{{$aal->name}}
               <i class='fas fa-circle connect' style='color:red;'></i>
            </a>
            </li>
            
          @endif
          @if($aal->id!="12")
       <li class="aal  col-12 col-lg-5 col-md-5 col-sm-12 ">
       <a href="/{{$aal->name}}/{{$aal->id}}/logger" class="myaal">{{$aal->name}}
         <i class='fas fa-circle connect' style='color:green;'></i></a>
       </li>
          @endif
